...
export const tagMembers = {
  ...
  "MDQ6VXNlcjQ2NjIyOQ==": {
    name: "Amy Guy",
    ghLogin: "rhiaro",
    terms: [term("2023-02-01", "2025-02-01")],
  ...
  "MDQ6VXNlcjE1NjE2MzA=": {
    ...
    ghLogin: "maxpassion",
    terms: [term("2024-02-01", "2026-02-01")],
    attendanceAliases: ["dapeng", "max"],
  },
  MDQ6VXNlcjQzOTI0: {
    name: 'Sangwhan "fish" Moon',
    ghLogin: "cynthia",
    terms: [term("2017-02-01", "2024-02-01")],
    attendanceAliases: ["sangwhan"],
  },
  "MDQ6VXNlcjQ5NTA4Mg==": {
    name: "Tristan Nitot",
    ghLogin: "nitot",
